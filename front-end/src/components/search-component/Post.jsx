  ...
  return (
    <div className=" h-60 flex my-11   transform overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-md duration-300 hover:scale-105 hover:shadow-lg">
      ...
      <div className="p-4  w-2/3">
        <h2 className="mb-2 text-lg font-medium dark:text-white text-gray-900">{post.nomconducteur}</h2>
        ...
        <p className="mb-2 hidden sm:block text-base dark:text-gray-300 text-gray-700">Description : {post.desc.split('.')[0]}</p>

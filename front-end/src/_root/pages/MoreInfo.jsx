...
const MoreInfo = () => {
  ...
  return (
    <div className="mx-auto flex my-11  w-2/3 transform overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-md duration-300  hover:shadow-lg">
        <div className="p-4 ">
          <h2 className="mt-2 text-lg font-medium dark:text-white text-gray-900">{clickedPost.nomconducteur}</h2>
          ...
          <p className="my-3 text-base dark:text-gray-300 text-gray-700">📞 {clickedPost.contact} </p>
